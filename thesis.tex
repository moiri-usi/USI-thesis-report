...
in Japan) by adding redundant recourses. Accurate failure prediction systems
may be a key to reduce these recourses or to increase the dependability.
...
\begin{itemize}
    ...
    \item replace $\alpha$ vector \glspl{fifo} with \gls{ram} blocks
\end{itemize}
