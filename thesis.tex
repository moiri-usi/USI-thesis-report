...
$\alpha$ vector compuation. The control signal are not labeled here for reasons
of lisibility and will be explained in detail in chapter \ref{ch:design_ctrl}.
